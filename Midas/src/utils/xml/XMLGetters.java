...
public class XMLGetters {
    ...
    * 
    * @param element
    *           - le noeud auquel l'enfant est directement rattaché.
    * @param childName
    *           - le nom de l'enfant .
    ...
    *           - le nom de l'enfant.
    * @param defaultValue
    *           - la valeur à retourner en cas d'échec.
    ...
    * 
    * @param element
    *           - le noeud auquel appartient l'attribut.
    * @param name
   ...
   public static int getIntegerAttribute(Element element, String attributeName,
      ...
      try {
         ...
         MidasLogs.errors.push("XMLGetters",
               "Integer parse error for attribute \"" + element.getName() + "."
                     + attributeName + "\".");
      }
   ...
   /**
    * Retourne la chaîne de caractères contenue par l'enfant direct du noeud
    * donné. Permet de spécifier la valeur à retourner si l'enfant n'existe pas.
    * 
    * @param element
    *           - le noeud auquel l'enfant est directement rattaché.
    * @param childName
    *           - le nom de l'enfant direct.
    * @param defaultValue
    *           - la valeur à retourner si l'enfant n'existe pas.
   ...
   public static String getStringChild(Element element, String childName,
      ...
      if (result == null) {
         MidasLogs.errors.push("XMLGetters", "Missing XML child : \""
               + childName + "\".");
         result = defaultValue;
      }
   ...
   /**
    * Retourne la chaîne de caractères d'un attribut du noeud donné en
    * paramètre.
    * 
    * @param element
    *           - le noeud auquel appartient l'attribut.
    * @param name
    *           - le nom de l'attribut à récupérer.
    * @return La valeur de l'attribut, ou une chaîne vide si l'attribut n'existe
    *         pour le noeud donné.
    */
   public static String getStringAttribute(Element element,
