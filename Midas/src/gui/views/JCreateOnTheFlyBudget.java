...
public class JCreateOnTheFlyBudget extends JDialog implements View {
    ...
    * @param budget
    *           - le budget à la volée à remplir.
    */
    ...
    * 
    * @param listener
    *           - l'action à effectuer lors de l'appui sur le bouton.
    */
   ...
   /**
    * Vérifie que l'objet complété par l'utilisateur est peut être sauvegardé
