...
/**
 * Fenêtre d'affichage et de création d'une nouvelle transaction sur un compte.
 * 
...
public class JNewTransaction extends JDialog implements View {
   ...
   /**
    * Crée la fenêtre de création de transaction.
    * 
    * @param controller
    *           - le contrôleur de la fenêtre.
    * @param transaction
    *           - la nouvelle transaction à remplir.
    */
    ...
    * 
    * @return Le panneau contenant les composants.
    */
