...
/**
 * Comprend une routine de test qui vérifie les fonctionnalités du paquetage
 * "database" et ses sous-paquetages.
 * 
...
public class TestRoutine {
   ...
   /**
    * Routine de test qui vérifie toutes les méthodes du DBController.
    * 
    * @param args
    *           - les arguments de l'appel (inutilisés).
    ...
    *            - levée en cas d'erreur lors de la mise en pause du processus.
    */
   public static void main(String[] args) throws DatabaseException,
         DatabaseConstraintViolation, InterruptedException {
      ...
      DBBudgetOnTheFly tempBudgetOnTheFly1 = dbController
            .createDbBudgetOnTheFly();
      tempBudgetOnTheFly1 = dbController.getDbBudgetOnTheFly(budgetOnTheFly1
            .getId());
      ...
      DBFinancialTransaction tempTrans = dbController
      ...
      // ----------------------------------------------------------------------
      for (Object line : dbController
            .getAllDbFinancialTransactionsRelatedToBudget(1)) {
         System.out.println(line);
      }
      for (Object line : dbController
            .getAllDbFinancialTransactionsRelatedToAccount(1)) {
         System.out.println(line);
      }
      ...
      dbController.saveToDatabase(budgetOnTheFly1);
      System.out.println(dbController.getDbBudgetOnTheFly(budgetOnTheFly1
            .getId()));
      ...
      for (Object line : dbController.getAllChildCategories(1)) { // Cat 11
                                                                  // attendu
         System.out.println(line);
      }
      for (Object line : dbController.getAllChildCategories(2)) { // rien
                                                                  // attendu
         System.out.println(line);
      }
